...
public final class EnhanceNature implements IProjectNature
{
    ...
    public static void toggleNature(IProject project, boolean enable) throws CoreException
    {
        ...
        // this will cause an instance of this class to run and toggle the builders
    ...
    private void toggleBuilder(boolean enable, String message) throws CoreException
    {
        ...
        // TOOD: add warning on full build and/or allow specifing classpath / better monitor
    ...
    {
        List<ICommand> list = toggle(desc.getBuildSpec(), EnhancerConstants.BUILDER_ID, enable,
            new ICallback<ICommand>()
            {
                @Override public ICommand create()
                {
